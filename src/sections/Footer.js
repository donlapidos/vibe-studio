    ...
    return (
        <Section>
            <LogoContainer data-scroll data-scroll-speed="2">
                ...
                <h3 data-scroll data-scroll-speed="-1">Vibe Studio</h3>
            </LogoContainer>
            <FooterContainer
                initial={{ y: "-400px" }}
                whileInView={{ y: 0 }}
            ...
            >
                ...
                <Bottom>
                    ...
                    <span data-scroll data-scroll-speed="-2">Made with &hearts; by &nbsp;
                        <a href="https://github.com/donlapidos" target="_blank" rel='noreferrer'>
                            Leo
                        </a>
                    </span>
                </Bottom>
